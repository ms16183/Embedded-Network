<!--ts-->
   ...
   * [組み込みシステム(Embedded System)](#組み込みシステムembedded-system)
...
- ハードウェアもソフトウェアも取り外すことができない．
- IoT(Internet of Things)を支える技術である．
  - あらゆるものをインターネットに接続する．
- 応用(アプリケーション)システム
  - スマートフォン，タブレット，自動車，炊飯器etc
